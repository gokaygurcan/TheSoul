...
.queueItem div.details h3.details-title {
    color: #ffffff;
    font-size: 24px;
    font-weight: bold;
    text-align: center;
...
.queueItem div.details div.details-effect {
...
.queueItem div.details span.details-rarity.rarity-common {
    background-color: #0093ff;
}

.queueItem div.details span.details-rarity.rarity-uncommon {
    background-color: #35bd86;
}

.queueItem div.details span.details-rarity.rarity-rare {
    background-color: #ff4c40;
}

.queueItem div.details span.details-rarity.rarity-legendary {
    background-color: #ab5bb5;
}

.queueItem div.details span.details-edition {
    background-color: #7278d0;
}

.queueItem div.details span.details-rarity,
.queueItem div.details span.details-edition {
    color: #ffffff;
    border: none;
    border-radius: 25px;
...
`;
    ...
    function parseCardItem(item) {
        ...
        const details = jokerDetails[cardName] || null;
        ...
        shopQueues.forEach(({ title, queue, boss, voucher, tags, packs }) => {
            ...
            queue.forEach(item => {
                ...
                if (details) {
                    ...
                    cardNameElement.className = 'details-title';
                    detailsElement.appendChild(cardNameElement);
